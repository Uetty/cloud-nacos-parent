...
import com.uetty.nacos.spring.simple.entity.PagedResponseData;
import com.uetty.nacos.spring.simple.enums.ResponseCode;
...
public class BaseController {
    ...
    protected <T> BaseResponse<T> baseResponse(ResponseCode responseCode, String message) {
        ...
        baseResponse.setStatus(responseCode.getId());
    ...
    protected <T> BaseResponse<T> successResult(T resultData) {
        ...
        baseDataResponse.setStatus(ResponseCode.SUCCESS.getId());
